...
the maximum number of topics a 2-person team can know. And also find out how
many teams can know that maximum number of topics.
...
topics. N lines follow. Each line contains a binary string of length M. If
the ith line's jth character is 1, then the ith person knows the jth topic;
...
# Create a list of possible team combinations (maybe just a generator)
# Use Binary Bitwise Operators to determine max topics possible for each team
# Keep track of the max possible topics number and how many teams can know that much  # NOQA
